...
def similarity_score(person1,person2):
	...
	for item in dataset[person1]:
		...
		sum_of_eclidean_distance = [
		    ...
		    for item in dataset[person1] if item in dataset[person2]
		]	
...
def pearson_correlation(person1,person2):
	...
	both_rated = {item: 1 for item in dataset[person1] if item in dataset[person2]}
	...
	return 0 if denominator_value == 0 else numerator_value/denominator_value 
